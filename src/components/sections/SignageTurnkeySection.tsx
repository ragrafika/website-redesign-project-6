      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-justify sm:text-center">
          ...
          <div className="mb-12">
            <h3 className="text-2xl md:text-3xl font-bold mb-8">Как мы работаем</h3>
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                ...
                <div key={i} className="bg-muted/30 rounded-xl shadow-md p-5 relative">
          ...
          <div className="mb-12">
            <h3 className="text-2xl md:text-3xl font-bold mb-3">Комплектации уличных вывесок</h3>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                >
                  ...
                  <h4 className="text-xl font-bold mb-1">{tier.title}</h4>
          ...
          <div className="mb-12">
            <h3 className="text-2xl md:text-3xl font-bold mb-3">На что обратить внимание при выборе вывески</h3>
            <p className="text-gray-700 mb-8">
            ...
            <div className="grid sm:grid-cols-2 gap-5 mb-6">
              {[
                ...
                <div key={i} className="bg-muted/30 rounded-xl shadow-md p-5 flex gap-3">
          ...
          <div className="mb-12">
            <h3 className="text-2xl md:text-3xl font-bold mb-3">География наших проектов</h3>
            <p className="text-gray-700 mb-8">
            ...
            <div className="bg-muted/30 rounded-xl shadow-md p-6 md:p-8">
          ...
          <div className="bg-gradient-to-r from-primary to-primary/80 rounded-xl p-6 md:p-8 mb-8 text-white">
            <div className="text-center">
              <h3 className="text-2xl md:text-3xl font-bold mb-3">Нужна консультация?</h3>
          ...
          <div>
            <h3 className="text-2xl md:text-3xl font-bold mb-8">Частые вопросы</h3>

            <div className="space-y-4">
              <details className="bg-muted/30 rounded-lg shadow-md group">
...
export default SignageTurnkeySection;
