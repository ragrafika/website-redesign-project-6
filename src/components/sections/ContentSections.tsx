...
const ContentSections = () => {
  ...
  return (
    <>
      <section id="advantages" className="py-20 bg-muted/30 scroll-mt-24">
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Поможем с согласованием и оформлением документов</p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Бесплатная табличка с режимом работы к каждой вывеске</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Полный цикл работ от идеи до установки</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="portfolio" className="py-20 scroll-mt-24 bg-secondary">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white">Портфолио</h2>
      ...
      <section id="testimonials" className="py-20 bg-muted/30 scroll-mt-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row items-stretch justify-center gap-4 max-w-3xl mx-auto">
            <a 
              ...
              className="flex items-center gap-2 px-6 py-3 bg-white border-2 border-gray-200 rounded-lg hover:border-primary hover:shadow-lg transition-all duration-300 group flex-1 shadow-sm"
            >
