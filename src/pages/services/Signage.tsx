...
const Signage = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Виды вывесок в Благовещенске | Объемные буквы, световые короба | Графика</title>
        ...
        <meta property="og:title" content="Виды вывесок в Благовещенске | Объемные буквы и световые короба" />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-50 rounded-xl p-6 md:p-8 mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h3 className="font-bold text-lg mb-1">Нужна вывеска под ключ?</h3>
                <p className="text-gray-600 text-sm">От дизайна и согласования в администрации до изготовления и монтажа — всё возьмём на себя.</p>
              </div>
              <Link to="/signage-turnkey" className="flex-shrink-0">
