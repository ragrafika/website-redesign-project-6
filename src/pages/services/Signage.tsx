            ...
            <div className="mb-12">
              ...
              <div className="space-y-4">
                ...
                <details className="bg-white rounded-lg shadow-md group">
                  ...
                  <div className="px-6 pb-6 text-gray-700">
                    На изготовление и монтаж гарантия 1-3 года. Срок гарантии зависит от выбранного вами бюджета. В течение гарантийного срока бесплатно устраняем любые неисправности, возникшие не по вине клиента.
                  </div>
                </details>
