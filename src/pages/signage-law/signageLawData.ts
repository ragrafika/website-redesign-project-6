  ...
  },
  {
    ...
    keyPoints: [
      ...
      },
      {
        ...
        text: "Использование иностранных слов, латиницы и заимствованных названий допускается только при наличии русскоязычного текста. Вывеска только на иностранном языке — нарушение закона.",
      },
      {
        icon: "ShieldCheck",
        title: "Кого касается",
