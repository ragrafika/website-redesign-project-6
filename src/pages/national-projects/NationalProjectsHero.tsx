  ...
  return (
    <div className="mb-10">
      ...
      <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-2xl mb-8">
        Участвуем в нацпроектах «Молодёжь и дети», «Семья» и «Культура» — работаем
        по прямым договорам с заказчиками и через генеральных подрядчиков.
        Более 150 изделий: вывески, навигация, интерьерное оформление.
      </p>
