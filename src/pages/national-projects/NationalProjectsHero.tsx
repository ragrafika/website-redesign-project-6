  ...
  return (
    <div className="mb-10">
      ...
      <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-2xl mb-8">
        Наша компания — подрядчик по наружному и интерьерному оформлению на объектах
        нескольких нацпроектов. Вывески, навигация, брендирование, выставочные системы —
        всё в соответствии с требованиями госзаказа и корпоративными стандартами.
      </p>
