...
export const PROJECTS: NatProject[] = [
  {
    ...
    ourRole:
      "Участвуем в качестве подрядчика по наружному и интерьерному оформлению объектов: фасадные вывески, навигация, информационные стенды на жилых комплексах и инфраструктурных объектах.",
  ...
  },
  {
    ...
    ourRole:
      "Оформляем спортивные объекты: наружные вывески, брендирование арен и залов, тематическое интерьерное оформление, навигация.",
...
export const COMPANY_STATS = [
  { value: "5+", label: "Нацпроектов", sub: "уже участвуем" },
  { value: "200+", label: "Объектов", sub: "оформлено" },
  { value: "10", label: "Лет", sub: "опыт в отрасли" },
